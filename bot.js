...
client.on('interactionCreate', async (interaction) => {
  ...
  const questions = [
    { key: 'name', question: 'What is your name? (if no answer provided, "LEPOOKIE" will be used)' },
    ...
    {
      key: 'photo',
      question: 'Please upload a photo for the card. (Send `NO` character in case you want to use your own Discord avatar)',
    },
  ];
